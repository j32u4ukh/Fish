...
class Convolution:
    ...
    def forward(self, x):
        ...
        # col.shape = (batch_size * out_h * out_w, channel * f_height * f_width)
        col = im2col(x, FH, FW, self.stride, self.padding)
        # col_W.shape = (FN, channel * f_height * f_width).T
        #             = (channel * f_height * f_width, FN)
        col_W = self.W.reshape(FN, -1).T

        # col.shape = (batch_size * out_h * out_w, FN)
